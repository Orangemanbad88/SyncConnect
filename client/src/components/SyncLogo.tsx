        ...
        <h1 
          ...
          style={{ 
            textShadow: `
              ...
              0 0 10px rgba(255, 91, 91, 0.6),
              0 0 15px rgba(255, 91, 91, 0.4),
              0 0 20px rgba(255, 91, 91, 0.3),
              0 0 30px rgba(255, 255, 255, 0.2)
            `,
            letterSpacing: '0.2em',
            fontVariationSettings: '"wght" 900',
            // Add a reddish metallic sheen effect with a hint of white
            background: 'linear-gradient(to bottom, #FFFFFF 0%, #FF5B5B 15%, #E04545 50%, #FF3838 85%, #FFFFFF 100%)',

...
const HeroHeader: React.FC<HeroHeaderProps> = ({ opacity }) => {
  return (
    <div 
      className="absolute top-0 left-0 w-full bg-[var(--primary-coral)] text-white shadow-lg z-10 transition-all duration-700 ease-in-out"
      style={{ 
        opacity: opacity,
    ...
    >
      <div className="container mx-auto px-6 py-8 flex flex-col items-center justify-center h-full">
        ...
        <h1 className="mt-4 text-5xl font-['Poppins'] font-bold text-white tracking-wider">
          S Y N C
        </h1>
        <p className="mt-3 text-xl text-white max-w-xl text-center">
